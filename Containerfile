...
RUN apt update -y && apt install -y automake autoconf libtool libtool-bin gcc libltdl7 libltdl-dev libxml2 libxml2-dev libxslt1.1 libxslt1-dev openssl libssl3 libssl-dev libnspr4 libnspr4-dev libnss3 libnss3-dev libnss3-tools libgnutls30 libgcrypt20 libgcrypt20-dev help2man man2html gtk-doc-tools

RUN cd /opt && git clone https://github.com/lsh123/xmlsec.git && cd xmlsec && ./autogen.sh && make && make install
